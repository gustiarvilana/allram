...
@push('js')
    <script>
        let table;
        var url_add = '{{ route('security.usermenu.store') }}'
        var url_delete = '{{ route('security.usermenu.destroy', ['id' => ':id']) }}';
        var url_edit = '{{ route('security.usermenu.update', ['id' => ':id']) }}';
        ...
        $(document).ready(function() {
            table = $("#table").DataTable({
                ...
                "ajax": {
                    url: '{{ route('security.usermenu.data') }}',
                },
                "columns": [{
                    data: 'DT_RowIndex',
                    searchable: false,
