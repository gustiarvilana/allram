            ...
            table = $("#table").DataTable({
                ...
                "columns": [{
                    ...
                    render: function(data, type, row) {
                        ...
                        return `
                            <div class="btn-group">
                                <button class="btn btn-sm btn-warning" style="display:${display}" id="penjualan-edit" data-id='${row.id_penjualan}' data-tgl_penjualan='${row.tgl_penjualan}' data-nik='${row.nik}' data-kd_produk='${row.kd_produk}' data-jumlah='${row.jumlah}' data-galon_kembali='${row.galon_kembali}' > Pinjam</button>
                                <button class="btn btn-sm btn-primary" id="penjualan-edit" data-id='${row.id_penjualan}' data-tgl_penjualan='${row.tgl_penjualan}' data-nik='${row.nik}' data-kd_produk='${row.kd_produk}' data-jumlah='${row.jumlah}' data-galon_kembali='${row.galon_kembali}' > Edit</button>
                                <button class="btn btn-sm btn-danger" id="penjualan-delete" data-id='${row.id_penjualan}' data-tgl_penjualan='${row.tgl_penjualan}' data-nik='${row.nik}' data-kd_produk='${row.kd_produk}' data-jumlah='${row.jumlah}' data-galon_kembali='${row.galon_kembali}' > Delete</button>
                            </div>
                        `;
                    }
